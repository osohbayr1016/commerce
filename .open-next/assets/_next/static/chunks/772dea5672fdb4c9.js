(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,37422,e=>{"use strict";var s=e.i(43476),i=e.i(71645),n=e.i(41605);function r(){let[e,r]=(0,i.useState)(""),[a,t]=(0,i.useState)(!1),l=(0,n.createClient)(),o=async()=>{t(!0),r("Running diagnostics...\n\n");try{let{data:{session:e}}=await l.auth.getSession();r(s=>s+`✓ Current session: ${e?"Logged in":"Not logged in"}
