    ...
    <footer className="bg-white border-t border-gray-200 mt-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10">
          ...
          <div>
            <h3 className="text-lg md:text-xl font-semibold text-gray-900 mb-5">Туслах цэс</h3>
          ...
          <div>
            <h3 className="text-lg md:text-xl font-semibold text-gray-900 mb-4">Холбоо барих</h3>
            ...
            <a href="mailto:test@gmail.com" className="text-gray-700 hover:text-gray-900 block text-base">
        ...
        <div className="mt-10 border-t border-gray-200 pt-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4 text-sm text-gray-500">
          <p>2026 © Онлайн худалдааг хөгжүүлэгч платформ.</p>
