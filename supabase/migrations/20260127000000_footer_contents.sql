...
-- Stores all footer content sections (company info, links, contact info, etc.)

create table if not exists public.footer_contents (
  id serial primary key,
  section text not null, -- 'company', 'social', 'help_menu', 'contact', 'bottom_links'
  key text not null, -- unique identifier within section (e.g., 'title', 'description', 'facebook_url')
